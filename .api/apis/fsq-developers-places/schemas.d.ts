        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly country_codes: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "The list of country codes to include in the job. Valid country codes can be found [here](https://docs.foursquare.com/fsq-developers-places/reference/batch-place-match-1#valid-countries).";
                };
            };
            readonly required: readonly [];
        }, {
...
export { Autocomplete, GeotaggingCandidates, GeotaggingConfirm, OfflineJobsCredentialsRefresh, OfflineJobsExecute, OfflineJobsInitialize, OfflineJobsStatus, PlaceDetails, PlaceFlag, PlacePhotos, PlaceSearch, PlaceSuggestEdit, PlaceSuggestRemove, PlaceSuggestStatus, PlaceTips, PlaceTopVenueWoes, PlacesSuggestPlace, SuggestMerge };
